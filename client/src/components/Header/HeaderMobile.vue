<template>
        ...
        <div class="row h-100" style="align-items: center;">
            ...
            <div class="h-100 col md-6 md-o-2 col-6 col-o-1">
                <div class="nav-mobile__logo h-100">
                    <p class="frame__name"> Ivy<span>Academia();</span></p>
    ...
    <nav class="nav-mobile__menu">
        ...
        <ul class="nav-mobile__list">
            ...
            <li class="nav-mobile__item">
                <font-awesome-icon :icon="['fas', 'map-marker-alt']" class="nav-mobile__icon" />
                <router-link :to="{ name: 'contact' }" class="nav-mobile__link">Liên hệ</router-link>
            </li>
